/*
  ...
  - The values [DANA,GOPAY,QRIS,TRANSFER_BANK] on the enum `MetodePembayaran` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "MetodePembayaran_new" AS ENUM ('dana', 'gopay', 'other_qris', 'bank_transfer');
