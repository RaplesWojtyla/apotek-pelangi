...
export default function AdminSidebar({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex">
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full bg-white shadow-md z-40 w-64 p-6 transition-transform duration-300 transform ${
      ...
      {/* Toggle Button */}
      <div
        className={`fixed top-20 transition-all duration-300 z-50 ${
