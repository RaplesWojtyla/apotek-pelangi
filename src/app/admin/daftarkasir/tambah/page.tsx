  ...
  return (
    <div className="min-h-screen p-6 bg-background text-foreground">
      ...
      <div className="mb-6 text-sm text-muted-foreground">
        ...
        &gt; <span className="text-foreground font-medium">Tambah Kasir</span>
      </div>

      {/* Page Title */}
      <h1 className="text-3xl font-bold mb-8">Tambah Kasir</h1>

      {/* Form Card - Posisi kiri */}
      <div className="w-full max-w-2xl bg-card p-6 rounded-xl shadow-sm border space-y-6">
        {/* Informasi Pengguna */}
        <section className="space-y-4">
          <h2 className="text-lg font-semibold text-foreground">Informasi Kasir</h2>
